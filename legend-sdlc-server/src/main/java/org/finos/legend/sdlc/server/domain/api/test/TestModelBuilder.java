...
public class TestModelBuilder
{
    ...
    public List<Entity> buildEntitiesForTest(String upstreamProjectId, String upstreamWorkspaceId, WorkspaceType type, String upstreamRevisionId, String downstreamProjectId, String downstreamVersionId)
    {
        ...
        Set<ProjectDependency> latestUpstreamLevel1Dependencies = this.dependenciesApi.getWorkspaceRevisionUpstreamProjects(upstreamProjectId, WorkspaceSpecification.newWorkspaceSpecification(upstreamWorkspaceId, type), upstreamRevisionId, false);
        ...
        List<Entity> upstreamProjectWorkspaceEntities = this.entityApi.getWorkspaceRevisionEntityAccessContext(upstreamProjectId, WorkspaceSpecification.newWorkspaceSpecification(upstreamWorkspaceId, type), upstreamRevisionId).getEntities(null, null, null);
