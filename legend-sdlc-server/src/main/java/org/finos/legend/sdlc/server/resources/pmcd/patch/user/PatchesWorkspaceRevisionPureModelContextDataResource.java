...
@Path("/projects/{projectId}/patches/{patchReleaseVersion}/workspaces/{workspaceId}/revisions/{revisionId}/pureModelContextData")
...
public class PatchesWorkspaceRevisionPureModelContextDataResource extends PureModelContextDataResource
{
                                                        ...
                                                        @PathParam("revisionId") @ApiParam("Including aliases: head, latest, current, base") String revisionId)
    {
        ...
        return executeWithLogging(
                "getting Pure model context data for user workspace " + workspaceId + " in project " + projectId + " at revision " + revisionId + " for patch release version " + patchReleaseVersion,
                () -> getPureModelContextData(projectId, revisionId, this.entityApi.getWorkspaceRevisionEntityAccessContext(projectId, patchReleaseVersion, workspaceId, WorkspaceType.USER, revisionId))
        );
    }
}
