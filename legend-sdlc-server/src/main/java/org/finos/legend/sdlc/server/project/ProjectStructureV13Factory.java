...
public class ProjectStructureV13Factory extends ProjectStructureVersionFactory
{
    ...
    public static class ProjectStructureV12 extends MultiModuleMavenProjectStructure
    {
        ...
        private static final ImmutableMap<String, ProjectStructureV13Factory.ProjectStructureV12.MavenCoordinates> DEFAULT_EXTENSIONS_COLLECTION = Maps.immutable.with(
        ...
        private Dependency getExtensionsCollectionDependency(String extensionName, boolean includeVersion, boolean scopeTest)
        {
            ...
            if (dependency == null)
            {
                ProjectStructureV13Factory.ProjectStructureV12.MavenCoordinates mavenCoordinates = DEFAULT_EXTENSIONS_COLLECTION.get(extensionName);
