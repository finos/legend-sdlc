...
public class BackupPatchesWorkspaceRevisionProjectConfigurationResource extends BaseResource
{
                                                                         ...
                                                                         @PathParam("revisionId") @ApiParam("Including aliases: head, latest, current, base") String revisionId)
    {
        ...
        return executeWithLogging(
                ...
                () -> this.projectConfigurationApi.getBackupWorkspaceRevisionProjectConfiguration(projectId, WorkspaceSpecification.newUserWorkspaceSpecification(workspaceId, versionId), revisionId)
        );
    }
}
