...
public interface ProjectConfigurationApi
{
    ...
    {
        return getProjectConfiguration(projectId, SourceSpecification.patchSourceSpecification(patchReleaseVersionId), revisionId);
    }
    ...
    {
        return getAvailableArtifactGenerations(projectId, SourceSpecification.patchSourceSpecification(patchReleaseVersionId));
    }
