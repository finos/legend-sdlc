...
public class PatchesGroupWorkspaceWorkflowJobsResource extends BaseResource
{
                                             ...
                                             @QueryParam("status") @ApiParam("Only include workflow jobs with one of the given statuses") Set<WorkflowJobStatus> statuses)
    {
        ...
        return executeWithLogging(
                ...
                () -> this.workflowJobApi.getWorkspaceWorkflowJobAccessContext(projectId, WorkspaceSpecification.newWorkspaceSpecification(workspaceId, WorkspaceType.GROUP, ProjectFileAccessProvider.WorkspaceAccessType.WORKSPACE, versionId)).getWorkflowJobs(workflowId, statuses)
        );
    }
                                      ...
                                      @PathParam("workflowJobId") String workflowJobId)
    {
        ...
        return executeWithLogging(
                ...
                () -> this.workflowJobApi.getWorkspaceWorkflowJobAccessContext(projectId, WorkspaceSpecification.newWorkspaceSpecification(workspaceId, WorkspaceType.GROUP, ProjectFileAccessProvider.WorkspaceAccessType.WORKSPACE, versionId)).getWorkflowJob(workflowId, workflowJobId)
        );
    }
                                       ...
                                       @PathParam("workflowJobId") String workflowJobId)
    {
        ...
        return executeWithLogging(
                ...
                () ->
                {
                    String logs = this.workflowJobApi.getWorkspaceWorkflowJobAccessContext(projectId, WorkspaceSpecification.newWorkspaceSpecification(workspaceId, WorkspaceType.GROUP, ProjectFileAccessProvider.WorkspaceAccessType.WORKSPACE, versionId)).getWorkflowJobLog(workflowId, workflowJobId);
                                      ...
                                      @PathParam("workflowJobId") String workflowJobId)
    {
        ...
        return executeWithLogging(
                ...
                () -> this.workflowJobApi.getWorkspaceWorkflowJobAccessContext(projectId, WorkspaceSpecification.newWorkspaceSpecification(workspaceId, WorkspaceType.GROUP, ProjectFileAccessProvider.WorkspaceAccessType.WORKSPACE, versionId)).runWorkflowJob(workflowId, workflowJobId)
        );
    }
                                        ...
                                        @PathParam("workflowJobId") String workflowJobId)
    {
        ...
        return executeWithLogging(
                ...
                () -> this.workflowJobApi.getWorkspaceWorkflowJobAccessContext(projectId, WorkspaceSpecification.newWorkspaceSpecification(workspaceId, WorkspaceType.GROUP, ProjectFileAccessProvider.WorkspaceAccessType.WORKSPACE, versionId)).retryWorkflowJob(workflowId, workflowJobId)
        );
    }
                                         ...
                                         @PathParam("workflowJobId") String workflowJobId)
    {
        ...
        return executeWithLogging(
                ...
                () -> this.workflowJobApi.getWorkspaceWorkflowJobAccessContext(projectId, WorkspaceSpecification.newWorkspaceSpecification(workspaceId, WorkspaceType.GROUP, ProjectFileAccessProvider.WorkspaceAccessType.WORKSPACE, versionId)).cancelWorkflowJob(workflowId, workflowJobId)
        );
    }
}
