...
@Path("/projects/{projectId}/groupWorkspaces/{workspaceId}/revisions")
@Api("Revisions")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class GroupWorkspaceRevisionsResource extends BaseResource
{
    private final RevisionApi revisionApi;

    @Inject
    public GroupWorkspaceRevisionsResource(RevisionApi revisionApi)
    {
        this.revisionApi = revisionApi;
    }

    @GET
    @ApiOperation("Get all revisions for a group workspace")
    ...
    @GET
    @Path("{revisionId}")
    @ApiOperation("Get a revision of the group workspace")
