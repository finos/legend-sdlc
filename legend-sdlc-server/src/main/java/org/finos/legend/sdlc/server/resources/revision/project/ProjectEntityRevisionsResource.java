...
@Path("/projects/{projectId}/entities/{path}/revisions")
@Api("Revisions")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class ProjectEntityRevisionsResource extends BaseResource
{
    private final RevisionApi revisionApi;

    @Inject
    public ProjectEntityRevisionsResource(RevisionApi revisionApi)
    {
        this.revisionApi = revisionApi;
    }

    @GET
    @ApiOperation("Get all revisions for an entity in a project")
    ...
    @GET
    @Path("{revisionId}")
    @ApiOperation("Get a revision of an entity in a project")
