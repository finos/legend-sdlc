...
@Path("/projects/{projectId}/patches/{patchReleaseVersion}/groupWorkspaces/{workspaceId}/backup/revisions/{revisionId}/configuration")
@Api("Backup")
...
public class BackupPatchesGroupWorkspaceRevisionProjectConfigurationResource extends BaseResource
{
                                                                         ...
                                                                         @PathParam("revisionId") @ApiParam("Including aliases: head, latest, current, base") String revisionId)
    {
        ...
        return executeWithLogging(
                "getting project " + projectId + " configuration in backup group workspace " + workspaceId + " at revision " + revisionId + " for patch release version " + patchReleaseVersion,
                () -> this.projectConfigurationApi.getBackupWorkspaceRevisionProjectConfiguration(projectId, patchReleaseVersion, workspaceId, WorkspaceType.GROUP, revisionId)
        );
    }
}
