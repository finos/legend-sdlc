...
public class ProjectStructureV11Factory  extends ProjectStructureVersionFactory
{
    ...
    {
        return new ProjectStructureV11(projectConfiguration, projectExtensionsCollections);
    }
    ...
    public static class ProjectStructureV11 extends MultiModuleMavenProjectStructure
    {
        ...
        private static final String LEGEND_SDLC_VERSION = "0.39.0";
        private static final String LEGEND_SDLC_PROPERTY = "legend.sdlc.version";
        ...
        private static final String LEGEND_ENGINE_VERSION = "2.34.0";
        private static final String LEGEND_ENGINE_PROPERTY = "legend.engine.version";
        ...
        private ProjectStructureV11(ProjectConfiguration projectConfiguration, ProjectExtensionsCollections projectExtensionsCollections)
        {
           super(projectConfiguration, ENTITIES_MODULE_NAME, getEntitySourceDirectories(projectConfiguration), OTHER_MODULES.castToMap(), false, projectExtensionsCollections);
        ...
        {
            if (this.getProjectExtensionsCollections() != null && this.getProjectExtensionsCollections().getArtifactIds().get(extensionName) != null)
            {
                String groupId = this.getProjectExtensionsCollections().getPlatformGroupId();
                String artifactId = this.getProjectExtensionsCollections().getArtifactIds().get(extensionName);
                String versionId = includeVersion ?  this.getPlatformPropertyReference() : null;
        ...
        protected void addMavenProjectProperties(BiConsumer<String, String> propertySetter)
        {
            ...
            if (this.getPlatformPropertyName() != null)
            {
                propertySetter.accept(this.getPlatformPropertyName(), this.getProjectExtensionsCollections().getVersion());
            }
        }
        ...
        protected void addMavenProjectPluginManagement(BiFunction<String, VersionId, ProjectFileAccessProvider.FileAccessContext> versionFileAccessContextProvider, Consumer<Plugin> pluginConsumer)
        {
            ...
            pluginConsumer.accept(new LegendVersionPackagePluginMavenHelper(LEGEND_SDLC_GROUP_ID, LEGEND_SDLC_VERSION_PLUGIN, LEGEND_SDLC_VERSION, null, null).getPluginManagementPlugin(this, versionFileAccessContextProvider));
        }
...
//        @ModuleConfig(artifactType = ArtifactType.file_generation, type = ModuleConfigType.MODULE_DEPENDENCIES)
//        public void addFileGenerationDependencies(Consumer<? super String> moduleDependencyConsumer)
//        {
//            moduleDependencyConsumer.accept(getEntitiesModuleName());
//        }
        ...
        public void addVersionPackageModulePlugins(String name, BiFunction<String, VersionId, ProjectFileAccessProvider.FileAccessContext> versionFileAccessContextProvider, Consumer<Plugin> pluginConsumer)
        {
            ...
            pluginConsumer.accept(new LegendVersionPackagePluginMavenHelper(LEGEND_SDLC_GROUP_ID, LEGEND_SDLC_VERSION_PLUGIN, LEGEND_SDLC_VERSION, Collections.singletonList(entityInputDirectory), null).getPlugin(this, versionFileAccessContextProvider));
        }
        ...
        static String getEntityValidationTestCode()
        {
            return loadJavaTestCode(4, "EntityValidationTest");
        }

        // package private for testing
        static String getEntityTestSuiteCode()
        {
