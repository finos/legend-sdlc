...
public interface EntityApi
{
    ...
    {
        return getEntityAccessContext(projectId, SourceSpecification.patchSourceSpecification(patchReleaseVersionId));
    }
    ...
    {
        return getEntityAccessContext(projectId, SourceSpecification.patchSourceSpecification(patchReleaseVersionId), revisionId);
    }
