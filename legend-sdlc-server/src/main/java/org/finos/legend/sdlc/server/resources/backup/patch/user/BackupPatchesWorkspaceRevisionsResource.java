...
public class BackupPatchesWorkspaceRevisionsResource extends BaseResource
{
                                       ...
                                       @QueryParam("limit") Integer limit)
    {
        ...
        return executeWithLogging(
                ...
                () -> this.revisionApi.getBackupWorkspaceRevisionContext(projectId, SourceSpecification.newUserSourceSpecification(workspaceId, versionId)).getRevisions(null, ResolvedInstant.getResolvedInstantIfNonNull(since), ResolvedInstant.getResolvedInstantIfNonNull(until), limit)
        );
    }
                                ...
                                @PathParam("revisionId") @ApiParam("Including aliases: head, latest, current, base") String revisionId)
    {
        ...
        return executeWithLogging(
                ...
                () -> this.revisionApi.getBackupWorkspaceRevisionContext(projectId, SourceSpecification.newUserSourceSpecification(workspaceId, versionId)).getRevision(revisionId)
        );
    }
}
