...
public class GroupConflictResolutionWorkspaceRevisionEntitiesResource extends EntityAccessResource
{
                                  ...
                                  @PathParam("path") String path)
    {
        return executeWithLogging(
                ...
                () -> this.entityApi.getEntityAccessContext(projectId, SourceSpecification.workspaceSourceSpecification(WorkspaceSpecification.newWorkspaceSpecification(workspaceId, WorkspaceType.GROUP, WorkspaceAccessType.CONFLICT_RESOLUTION)), revisionId).getEntity(path)
        );
    }
}
