...
public class FinosFileLoader
{
    ...
    FinosFileLoader(ClassLoader classLoader, String fileName, String schemaSignature)
    {
        this.classLoader = classLoader;
        this.fileName = fileName;
        this.schemaSignature = (schemaSignature == null) ? "yml" : schemaSignature;
    }
    ...
    {
        String resourceName = "org/finos/legend/sdlc/server/gitlab/finos/" + this.fileName + "-" + version + "." + this.schemaSignature;
