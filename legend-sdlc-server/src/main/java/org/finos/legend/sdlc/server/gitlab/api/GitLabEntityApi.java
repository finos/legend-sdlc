...
public class GitLabEntityApi extends GitLabApiWithFileAccess implements EntityApi
{
    ...
    {
        return this.getWorkspaceWithConflictResolutionEntityAccessContext(projectId, workspaceId, false);
    }
    ...
    {
        return this.getWorkspaceWithConflictResolutionEntityAccessContext(projectId, workspaceId, true);
    }
    ...
    {
        return this.getWorkspaceEntityAccessContextByWorkspaceAccessType(projectId, workspaceId, getAdjustedWorkspaceAccessType(ProjectFileAccessProvider.WorkspaceAccessType.CONFLICT_RESOLUTION, isGroupWorkspace));
    }
    ...
    {
        return this.getBackupWorkspaceRevisionEntityAccessContext(projectId, workspaceId, false, revisionId);
    }
    ...
    {
        return this.getBackupWorkspaceRevisionEntityAccessContext(projectId, workspaceId, true, revisionId);
    }
    ...
    {
        return this.getWorkspaceRevisionEntityAccessContextByWorkspaceAccessType(projectId, workspaceId, revisionId, getAdjustedWorkspaceAccessType(ProjectFileAccessProvider.WorkspaceAccessType.BACKUP, isGroupWorkspace));
    }
