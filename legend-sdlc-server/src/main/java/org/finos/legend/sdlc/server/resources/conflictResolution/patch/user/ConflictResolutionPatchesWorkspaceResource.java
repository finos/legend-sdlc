...
@Path("/projects/{projectId}/patches/{patchReleaseVersion}/workspaces/{workspaceId}/conflictResolution")
...
public class ConflictResolutionPatchesWorkspaceResource extends BaseResource
{
    ...
    public Workspace getUserWorkspace(@PathParam("projectId") String projectId, @PathParam("patchReleaseVersion") String patchReleaseVersion, @PathParam("workspaceId") String workspaceId)
    {
        ...
        return executeWithLogging(
                "getting user workspace with conflict resolution " + workspaceId + " for project " + projectId + " for patch release version " + patchReleaseVersion,
                () -> this.workspaceApi.getWorkspaceWithConflictResolution(projectId, patchReleaseVersion, workspaceId, WorkspaceType.USER)
        );
    }
    ...
    public boolean isWorkspaceOutdated(@PathParam("projectId") String projectId, @PathParam("patchReleaseVersion") String patchReleaseVersion, @PathParam("workspaceId") String workspaceId)
    {
        LegendSDLCServerException.validateNonNull(patchReleaseVersion, "patchReleaseVersion may not be null");
        return executeWithLogging(
                "checking if user workspace with conflict resolution " + workspaceId + " of project " + projectId + " for patch release version " + patchReleaseVersion + " is outdated",
                () -> this.workspaceApi.isWorkspaceWithConflictResolutionOutdated(projectId, patchReleaseVersion, workspaceId, WorkspaceType.USER)
        );
    }
    ...
    public void discardConflictResolution(@PathParam("projectId") String projectId, @PathParam("patchReleaseVersion") String patchReleaseVersion, @PathParam("workspaceId") String workspaceId)
    {
        LegendSDLCServerException.validateNonNull(patchReleaseVersion, "patchReleaseVersion may not be null");
        executeWithLogging(
                "discarding conflict resolution for user workspace " + workspaceId + " in project " + projectId + " for patch release version " + patchReleaseVersion,
                () -> this.conflictResolutionApi.discardConflictResolution(projectId, patchReleaseVersion, workspaceId, WorkspaceType.USER)
        );
    }
    ...
    public void discardChangesConflictResolution(@PathParam("projectId") String projectId, @PathParam("patchReleaseVersion") String patchReleaseVersion, @PathParam("workspaceId") String workspaceId)
    {
        LegendSDLCServerException.validateNonNull(patchReleaseVersion, "patchReleaseVersion may not be null");
        executeWithLogging(
                "discarding all conflict resolution changes for user workspace " + workspaceId + " in project " + projectId + " for patch release version " + patchReleaseVersion,
                () -> this.conflictResolutionApi.discardConflictResolution(projectId, patchReleaseVersion, workspaceId, WorkspaceType.USER)
        );
    }
    ...
    public void acceptConflictResolution(@PathParam("projectId") String projectId, @PathParam("patchReleaseVersion") String patchReleaseVersion, @PathParam("workspaceId") String workspaceId, PerformChangesCommand command)
    {
        ...
        LegendSDLCServerException.validateNonNull(patchReleaseVersion, "patchReleaseVersion may not be null");
        executeWithLogging(
                "accept conflict resolution for user workspace " + workspaceId + " in project " + projectId + " for patch release version " + patchReleaseVersion,
                () -> this.conflictResolutionApi.acceptConflictResolution(projectId, patchReleaseVersion, workspaceId, WorkspaceType.USER, command)
        );
    }
}
