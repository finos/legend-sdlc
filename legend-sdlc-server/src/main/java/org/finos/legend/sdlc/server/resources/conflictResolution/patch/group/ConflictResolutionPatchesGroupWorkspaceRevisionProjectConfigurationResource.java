...
@Path("/projects/{projectId}/patches/{patchReleaseVersion}/groupWorkspaces/{workspaceId}/conflictResolution/revisions/{revisionId}/configuration")
...
public class ConflictResolutionPatchesGroupWorkspaceRevisionProjectConfigurationResource extends BaseResource
{
                                                                         ...
                                                                         @PathParam("revisionId") @ApiParam("Including aliases: head, latest, current, base") String revisionId)
    {
        ...
        return executeWithLogging(
                "getting project " + projectId + " configuration in group workspace with conflict resolution " + workspaceId + " at revision " + revisionId + " for patch release version " + patchReleaseVersion,
                () -> this.projectConfigurationApi.getWorkspaceWithConflictResolutionRevisionProjectConfiguration(projectId, patchReleaseVersion, workspaceId, WorkspaceType.GROUP, revisionId)
        );
    }
}
