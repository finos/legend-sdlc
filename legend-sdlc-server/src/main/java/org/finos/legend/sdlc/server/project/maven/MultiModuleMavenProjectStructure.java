...
public abstract class MultiModuleMavenProjectStructure extends MavenProjectStructure
{
    ...
    private final ProjectStructureExtensions projectStructureExtensions;
    ...
    ProjectStructureExtensions projectStructureExtensions
    )
    {
    ...
    public ProjectStructureExtensions getProjectStructureExtensions()
    {
        return this.projectStructureExtensions;
    }
    ...
    public Map<String, ProjectStructureExtensions.PlatformMetadata> getPlatformExtensions()
    {
        return this.projectStructureExtensions != null ? this.projectStructureExtensions.getPlatformExtensions() : null;
    }
