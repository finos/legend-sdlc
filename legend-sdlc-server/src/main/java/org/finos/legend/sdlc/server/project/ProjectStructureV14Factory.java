...
public class ProjectStructureV14Factory extends ProjectStructureVersionFactory
{
    @Override
    ...
    {
        return new ProjectStructureV14(projectConfiguration, projectStructurePlatformExtensions);
    }

    public static class ProjectStructureV14 extends MultiModuleMavenProjectStructure
    {
        ...
        private static final String LEGEND_SDLC_VERSION = "0.224.0";
        ...
        private static final String LEGEND_ENGINE_VERSION = "4.130.0";
        ...
        private ProjectStructureV14(ProjectConfiguration projectConfiguration, ProjectStructurePlatformExtensions projectStructurePlatformExtensions)
        {
