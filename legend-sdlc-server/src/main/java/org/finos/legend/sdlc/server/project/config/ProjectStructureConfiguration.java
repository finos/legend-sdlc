...
public class ProjectStructureConfiguration
{
    ...
    private final ProjectPlatformsConfiguration projectPlatformsConfiguration;

    private ProjectStructureConfiguration(Set<Integer> demisedVersions, ProjectStructureExtensionProvider extensionProvider, List<ProjectStructureExtension> extensions, ProjectCreationConfiguration projectCreationConfig, ProjectPlatformsConfiguration projectExtensionsCollectionConfiguration)
    {
        ...
        this.projectPlatformsConfiguration = projectExtensionsCollectionConfiguration;
    }
    ...
    public ProjectPlatformsConfiguration getProjectPlatformsConfiguration()
    {
        return this.projectPlatformsConfiguration;
    }
