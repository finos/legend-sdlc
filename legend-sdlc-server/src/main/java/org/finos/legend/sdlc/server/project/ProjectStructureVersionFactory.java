...
public abstract class ProjectStructureVersionFactory
{
    ...
    public final ProjectStructure newProjectStructure(ProjectConfiguration projectConfiguration, ProjectExtensionsCollections projectExtensionsCollections)
    {
        ...
        ProjectStructure projectStructure = createProjectStructure(projectConfiguration, projectExtensionsCollections);
        projectStructure.validate();
        return projectStructure;
    }

    protected abstract ProjectStructure createProjectStructure(ProjectConfiguration projectConfiguration, ProjectExtensionsCollections projectExtensionsCollections);
