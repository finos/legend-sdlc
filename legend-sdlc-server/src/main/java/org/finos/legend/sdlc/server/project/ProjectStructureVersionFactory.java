...
public abstract class ProjectStructureVersionFactory
{
    ...
    public final ProjectStructure newProjectStructure(ProjectConfiguration projectConfiguration, ProjectStructureExtensions projectStructureExtensions)
    {
        ...
        ProjectStructure projectStructure = createProjectStructure(projectConfiguration, projectStructureExtensions);
        projectStructure.validate();
        return projectStructure;
    }

    protected abstract ProjectStructure createProjectStructure(ProjectConfiguration projectConfiguration, ProjectStructureExtensions projectStructureExtensions);
