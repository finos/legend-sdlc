...
public abstract class ProjectStructure
{
    ...
    static ProjectFile getProjectConfigurationFile(FileAccessContext accessContext)
    {
        return accessContext.getFile(PROJECT_CONFIG_PATH);
    }

    static byte[] serializeProjectConfiguration(ProjectConfiguration projectConfiguration)
    {
        try
        {
    ...
    static ProjectConfiguration readProjectConfiguration(ProjectFile file)
    {
