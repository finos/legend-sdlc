...
public abstract class ProjectStructure
{
    ...
    public static ProjectStructure getProjectStructure(ProjectConfiguration projectConfiguration, ProjectStructureExtensions projectStructureExtensions)
    {
        return PROJECT_STRUCTURE_FACTORY.newProjectStructure(projectConfiguration, projectStructureExtensions);
    }
