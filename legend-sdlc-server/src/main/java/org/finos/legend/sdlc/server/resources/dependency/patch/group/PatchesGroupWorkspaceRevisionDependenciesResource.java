...
@Path("/projects/{projectId}/patches/{patchReleaseVersion}/groupWorkspaces/{workspaceId}/revisions/{revisionId}/upstreamProjects")
@Api("Dependencies")
...
public class PatchesGroupWorkspaceRevisionDependenciesResource extends BaseResource
{
                                                          ...
                                                          @QueryParam("transitive") @DefaultValue("false") boolean transitive)
    {
        ...
        return executeWithLogging(
                "getting upstream dependencies of project " + projectId + " for patch release version " + patchReleaseVersion + ", group workspace " + workspaceId + ", revision " + revisionId + " (fetch transitively = " + transitive + ")",
                () -> this.dependenciesApi.getWorkspaceRevisionUpstreamProjects(projectId, patchReleaseVersion, workspaceId, WorkspaceType.GROUP, revisionId, transitive)
        );
    }
}
