...
{
    protected static final LegendTestUtilsMavenHelper ALLOY_TEST_UTILS_MAVEN_HELPER = new LegendTestUtilsMavenHelper("platform.alloy", "alloy-metadata-sdlc-test-utils", "${alloy.version}");
