...
public class TestModelBuilderTest
{
    ...
    {
        return this.backend.getRevisionApi().getWorkspaceRevisionContext(projectId, WorkspaceSpecification.newWorkspaceSpecification(workspaceId, type)).getCurrentRevision().getId();
    }
