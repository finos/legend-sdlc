...
import org.finos.legend.sdlc.server.project.ProjectStructureV14Factory.ProjectStructureV14;
...
public class TestProjectStructureV14 extends TestMultiGenerationProjectStructure<ProjectStructureV14>
{
    ...
    @Override
    protected void collectExpectedProjectProperties(ProjectStructureV14 projectStructure, BiConsumer<String, String> propertyConsumer)
    {
        super.collectExpectedProjectProperties(projectStructure, propertyConsumer);
        propertyConsumer.accept("platform.legend-engine.version", "4.130.0");
        propertyConsumer.accept("platform.legend-sdlc.version", "0.224.0");
    }

    @Override
    protected void collectExpectedFiles(ProjectStructureV14 projectStructure, BiConsumer<String, String> expectedFilePathAndContentConsumer, Consumer<String> unexpectedFilePathConsumer)
    {
        super.collectExpectedFiles(projectStructure, expectedFilePathAndContentConsumer, unexpectedFilePathConsumer);
        expectedFilePathAndContentConsumer.accept(projectStructure.getModuleFilePath(projectStructure.getEntitiesModuleName(), ProjectStructureV14.ENTITY_VALIDATION_TEST_FILE_PATH), ProjectStructureV14.getEntityValidationTestCode());
    }

    @Override
    protected Map<ArtifactType, List<String>> getExpectedArtifactIdsByType(ProjectStructureV14 projectStructure)
    {
    ...
    @Override
    protected Class<ProjectStructureV14> getProjectStructureClass()
    {
        return ProjectStructureV14.class;
    }
    ...
    @Override
    protected void collectExpectedEntitiesModelDependencies(ProjectStructureV14 projectStructure, Consumer<Dependency> dependencyConsumer)
    {
    ...
    @Override
    protected void collectExpectedEntitiesModelPlugins(ProjectStructureV14 projectStructure, Consumer<Plugin> pluginConsumer)
    {
    ...
    @Override
    protected void collectExpectedProjectModelDependencyManagement(ProjectStructureV14 projectStructure, Consumer<Dependency> dependencyManagementConsumer)
    {
    ...
    protected void collectExpectedServiceExecutionModulePlugins(String name, ProjectStructureV14 projectStructure, Consumer<Plugin> pluginConsumer)
    {
    ...
    protected void collectExpectedServiceExecutionModuleDependencies(ProjectStructureV14 projectStructure, Consumer<Dependency> dependencyConsumer)
    {
    ...
    protected void collectExpectedFileGenerationModulePlugins(String name, ProjectStructureV14 projectStructure, Consumer<Plugin> pluginConsumer)
    {
