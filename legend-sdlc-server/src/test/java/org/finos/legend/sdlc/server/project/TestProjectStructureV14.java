...
public class TestProjectStructureV14 extends TestMultiGenerationProjectStructure<ProjectStructureV14Factory.ProjectStructureV14>
{
    ...
    @Override
    protected void collectExpectedProjectProperties(ProjectStructureV14Factory.ProjectStructureV14 projectStructure, BiConsumer<String, String> propertyConsumer)
    {
    ...
    @Override
    protected void collectExpectedFiles(ProjectStructureV14Factory.ProjectStructureV14 projectStructure, BiConsumer<String, String> expectedFilePathAndContentConsumer, Consumer<String> unexpectedFilePathConsumer)
    {
        super.collectExpectedFiles(projectStructure, expectedFilePathAndContentConsumer, unexpectedFilePathConsumer);
        expectedFilePathAndContentConsumer.accept(projectStructure.getModuleFilePath(projectStructure.getEntitiesModuleName(), ProjectStructureV14Factory.ProjectStructureV14.ENTITY_VALIDATION_TEST_FILE_PATH), ProjectStructureV14Factory.ProjectStructureV14.getEntityValidationTestCode());
    }

    @Override
    protected Map<ArtifactType, List<String>> getExpectedArtifactIdsByType(ProjectStructureV14Factory.ProjectStructureV14 projectStructure)
    {
    ...
    @Override
    protected Class<ProjectStructureV14Factory.ProjectStructureV14> getProjectStructureClass()
    {
        return ProjectStructureV14Factory.ProjectStructureV14.class;
    }
    ...
    @Override
    protected void collectExpectedEntitiesModelDependencies(ProjectStructureV14Factory.ProjectStructureV14 projectStructure, Consumer<Dependency> dependencyConsumer)
    {
    ...
    @Override
    protected void collectExpectedEntitiesModelPlugins(ProjectStructureV14Factory.ProjectStructureV14 projectStructure, Consumer<Plugin> pluginConsumer)
    {
        ...
        pluginConsumer.accept(new LegendJUnitTestGenerationPluginMavenHelper("org.finos.legend.sdlc", "legend-sdlc-test-generation-maven-plugin", "${platform.legend-sdlc.version}", getGenerationDependency(), true).getPlugin(projectStructure));
    }

    @Override
    protected void collectExpectedProjectModelDependencyManagement(ProjectStructureV14Factory.ProjectStructureV14 projectStructure, Consumer<Dependency> dependencyManagementConsumer)
    {
    ...
    protected void collectExpectedServiceExecutionModulePlugins(String name, ProjectStructureV14Factory.ProjectStructureV14 projectStructure, Consumer<Plugin> pluginConsumer)
    {
    ...
    protected void collectExpectedServiceExecutionModuleDependencies(ProjectStructureV14Factory.ProjectStructureV14 projectStructure, Consumer<Dependency> dependencyConsumer)
    {
    ...
    protected void collectExpectedFileGenerationModulePlugins(String name, ProjectStructureV14Factory.ProjectStructureV14 projectStructure, Consumer<Plugin> pluginConsumer)
    {
