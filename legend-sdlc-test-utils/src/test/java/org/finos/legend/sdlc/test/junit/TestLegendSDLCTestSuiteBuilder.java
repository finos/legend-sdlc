...
public class TestLegendSDLCTestSuiteBuilder
{
    ...
    protected void testTestSuiteBuilder(String entitiesResourceName, int expectedTestCount, int expectedTestCaseCount, int expectedErrors, int expectedFailures) throws Exception
    {
        ...
        {
            suite = new LegendSDLCTestSuiteBuilder(core_relational_relational_router_router_extension.Root_meta_pure_router_extension_defaultRelationalExtensions__RouterExtension_MANY_(PURE_MODEL.getExecutionSupport()), LegendPlanTransformers.transformers, "vX_X_X")
