...
public class TestTools
{
    ...
    public static Entity newClassEntity(String name, String pkg, List<? extends Map<String, ?>> properties, List<String> superTypes)
    {
        ...
        content.put("superTypes", ((superTypes == null) || superTypes.isEmpty()) ? Collections.singletonList(newSuper(ANY)) : superTypes.stream().map(TestTools::newSuper).collect(Collectors.toList()));
    ...
    public static Map<String, String> newSuper(String superType)
    {
