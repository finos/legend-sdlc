...
package org.finos.legend.sdlc.backend.gitlab.tools;
...
public class GitLabApiTools
{
    ...
    {
        // The pre-extraction implementation incremented a server-side prometheus counter here ("gitlab
        // retryable exception"); a metrics surface below the server awaits the deferred BackendEnvironment
        // metrics decision.
        LOGGER.debug("retryable GitLab exception");
    }
