...
import org.finos.legend.sdlc.backend.gitlab.api.GitLabProjectConfigurationApiTestResource;
...
public class TestGitLabServerProjectConfigurationApis extends AbstractGitLabServerApiTest
{
    ...
    private static void setUpProjectConfigurationApi()
    {
        ...
        GitLabProjectConfigurationApi gitLabProjectConfigurationApi = new GitLabProjectConfigurationApi(gitLabConfig, gitLabMemberUserContext, null, backgroundTaskProcessor, null);
