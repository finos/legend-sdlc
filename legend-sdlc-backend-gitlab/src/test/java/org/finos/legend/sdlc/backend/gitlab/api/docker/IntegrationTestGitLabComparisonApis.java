...
import org.finos.legend.sdlc.backend.gitlab.api.GitLabComparisonApiTestResource;
...
public class IntegrationTestGitLabComparisonApis extends AbstractGitLabApiTest
{
    ...
    private static void setUpComparisonApi()
    {
        ...
        GitLabComparisonApi gitLabComparisonApi = new GitLabComparisonApi(gitLabConfig, gitLabMemberUserContext, backgroundTaskProcessor);
