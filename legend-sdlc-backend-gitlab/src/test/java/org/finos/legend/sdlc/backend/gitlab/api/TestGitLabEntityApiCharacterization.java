...
public class TestGitLabEntityApiCharacterization
{
    ...
    public void testGetEntity()
    {
        ...
        // entity content is not round-trip identical in general: what is read back is the
        // serializer-normalized form (with the engine serializer extensions on the classpath, e.g. a class
        // gains superTypes/stereotypes/constraints; this module's tests run on the plain serializer)
