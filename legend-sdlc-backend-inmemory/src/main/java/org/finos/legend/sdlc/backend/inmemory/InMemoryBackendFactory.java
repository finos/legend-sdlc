...
public class InMemoryBackendFactory implements BackendFactory
{
    @Override
    public String getType()
    {
        return InMemoryBackend.TYPE;
    }

    @Override
    public Class<? extends BackendConfiguration> getConfigurationClass()
    {
        return InMemoryBackendConfiguration.class;
    }

    @Override
    public Backend build(BackendConfiguration configuration, BackendEnvironment environment)
    {
        return new InMemoryBackend(environment);
    }
}
