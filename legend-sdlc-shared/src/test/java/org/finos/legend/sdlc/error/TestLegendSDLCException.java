...
public class TestLegendSDLCException
{
    ...
    public void testConstructorDefaults()
    {
        ...
        Assert.assertEquals(500, new LegendSDLCException(message).getStatusCode());
        Assert.assertEquals(500, new LegendSDLCException(message, cause).getStatusCode());
        Assert.assertEquals(409, new LegendSDLCException(message, 409).getStatusCode());
        Assert.assertEquals(404, new LegendSDLCException(message, 404, cause).getStatusCode());
        Assert.assertEquals(message, new LegendSDLCException(message).getMessage());
        Assert.assertSame(cause, new LegendSDLCException(message, cause).getCause());
    }
    ...
    public void testValidateNonNull()
    {
        ...
        LegendSDLCException e2 = Assert.assertThrows(message, LegendSDLCException.class, () -> LegendSDLCException.validateNonNull(null, message, 500));
    ...
    public void testValidate_Message()
    {
        ...
        LegendSDLCException e2 = Assert.assertThrows(message, LegendSDLCException.class, () -> LegendSDLCException.validate(invalidObject, predicate, message, 501));
        Assert.assertEquals(message, e2.getMessage());
        Assert.assertEquals(501, e2.getStatusCode());
    }
    ...
    public void testValidate_MessageFunction()
    {
        ...
        LegendSDLCException e2 = Assert.assertThrows(message, LegendSDLCException.class, () -> LegendSDLCException.validate(invalidObject, predicate, messageFn, 409));
        Assert.assertEquals(message, e2.getMessage());
        Assert.assertEquals(2, messageFnCount[0]);
        Assert.assertEquals(409, e2.getStatusCode());
    }
}
