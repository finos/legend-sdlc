...
import org.finos.legend.sdlc.project.structure.extension.UpdateProjectStructureExtension;
...
import org.finos.legend.sdlc.project.structure.maven.LegendTestUtilsMavenHelper;
import org.finos.legend.sdlc.project.structure.maven.LegendVersionPackagePluginMavenHelper;
...
public class ProjectStructureV13Factory extends ProjectStructureVersionFactory
{
    ...
    public static class ProjectStructureV13 extends MultiModuleMavenProjectStructure
    {
        ...
        @Override
        public void collectUpdateProjectConfigurationOperations(ProjectStructure oldStructure, ProjectFileAccessProvider.FileAccessContext fileAccessContext, Consumer<ProjectFileOperation> operationConsumer)
        {
