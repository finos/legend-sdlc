...
package org.finos.legend.sdlc.structure.maven;
    ...
    private void legacyConfigureOtherModule(ArtifactType type, String name, MavenModelConfiguration configuration)
    {
        ...
        if (otherModuleConfigMethods != null)
        {
            ...
            if (propertiesMethod != null)
            {
                ...
                {
                    throw new LegendSDLCException("Error adding maven properties for module " + name, e);
                }
            }
            ...
            if (moduleDependenciesMethod != null)
            {
                ...
                {
                    throw new LegendSDLCException("Error adding maven module dependencies for module " + name, e);
                }
            }
            ...
            if (dependenciesMethod != null)
            {
                ...
                {
                    throw new LegendSDLCException("Error adding maven dependencies for module " + name, e);
                }
            }
            ...
            if (pluginsMethod != null)
            {
                ...
                {
                    throw new LegendSDLCException("Error adding maven plugins for module " + name, e);
                }
            }
        }
    }
