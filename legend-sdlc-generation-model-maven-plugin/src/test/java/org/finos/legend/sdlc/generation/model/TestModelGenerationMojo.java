...
public class TestModelGenerationMojo
{
    ...
    public void testEmptyEntitiesDirectory() throws Exception
    {
        ...
        File projectDir = buildSingleModuleProject("project", "com.gs.test", "test-project", "1.0.0", null, emptyEntityDirs, null);
    ...
    public void testNonExistentEntityDirectories() throws Exception
    {
        ...
        File projectDir = buildSingleModuleProject("project", "com.gs.test", "test-project", "1.0.0", null, nonExistentEntityDirectories, null);
        MavenProject mavenProject = this.mojoRule.readMavenProject(projectDir);
    ...
    private Plugin buildPlugin(ModelGenerationMojo.IncludedElementsSpecification inclusions, File outputDirectory)
    {
        Plugin plugin = new Plugin();
        plugin.setGroupId("platform.alloy");
        plugin.setArtifactId("alloy-metadata-sdlc-generation-model-maven-plugin");
        // config
    ...
    private Xpp3Dom buildIncludedElementsSpecification(String name, ModelGenerationMojo.IncludedElementsSpecification inclusions)
    {
    ...
    private ModelGenerationMojo.IncludedElementsSpecification buildIncludedElementsSpecification(List<Entity> entities, File[] directories)
    {
        ModelGenerationMojo.IncludedElementsSpecification inclusions = new ModelGenerationMojo.IncludedElementsSpecification();
        if (entities != null)
        {
