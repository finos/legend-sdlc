...
package org.finos.legend.sdlc.protocols;
...
public abstract class ProtocolToEntityConverter<T>
{
    ...
    private final JavaType entityContentType = this.objectMapper.getTypeFactory().constructMapType(Map.class, String.class, Object.class);
