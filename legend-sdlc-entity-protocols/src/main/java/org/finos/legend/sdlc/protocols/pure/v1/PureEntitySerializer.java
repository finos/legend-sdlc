...
public class PureEntitySerializer implements EntityTextSerializer
{
    ...
    {
        return PureToEntityConverter.isSupportedClassifier(entity.getClassifierPath()) &&
                // TODO find a better way to do this
                this.entityToPureConverter.fromEntityIfPossible(entity).map(this::serializeToString).isPresent();
    }
