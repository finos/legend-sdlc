...
package org.finos.legend.sdlc.backend.api.workflow;
...
public interface WorkflowJobApi
{
    ...
    {
        return getWorkflowJobAccessContext(projectId, SourceSpecification.patchSourceSpecification(patchReleaseVersionId));
    }
