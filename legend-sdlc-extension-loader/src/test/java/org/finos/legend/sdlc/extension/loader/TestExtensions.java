...
package org.finos.legend.sdlc.extension.loader;
...
public class TestExtensions
{
    ...
    // DO NOT DELETE ITEMS FROM THIS LIST (except when replacing them with something equivalent)
    private static final ImmutableList<Class<? extends EntitySerializer>> EXPECTED_ENTITY_SERIALIZER_EXTENSIONS = Lists.mutable.<Class<? extends EntitySerializer>>empty()
            .with(DefaultJsonEntitySerializer.class)
            .with(PureEntitySerializer.class)
            .toImmutable();
    ...
    @Test
    public void testExpectedPureEntitySerializerExtensionsArePresent()
    {
        assertHasExtensions(org.eclipse.collections.api.factory.Sets.mutable.withAll(EXPECTED_ENTITY_SERIALIZER_EXTENSIONS), EntitySerializer.class, true);
    }
